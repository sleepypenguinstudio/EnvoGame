...
public class LevelComplete1b1 : MonoBehaviour {
	...
	void Update () {
		if (CountDownC1Aqua.timerInSecond12>300  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC1Aqua.timerInSecond12 <= 120 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC1Aqua.timerInSecond12 <= 150 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC1Aqua.timerInSecond12 < 300&& StaticFlag.TotalOx == 5)
			starNo = 1;
