...
public class LevelComplete1e : MonoBehaviour {
	...
	void Update () {
		if (CountDownC4.timerInSecond4>500  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC4.timerInSecond4 <= 25 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC4.timerInSecond4 <= 30 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC4.timerInSecond4 < 500 && StaticFlag.TotalOx == 5)
			starNo = 1;
