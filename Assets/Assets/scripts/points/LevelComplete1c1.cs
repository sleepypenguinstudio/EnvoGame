...
public class LevelComplete1c1 : MonoBehaviour {
	...
	void Update () {
		if (CountDownC2Aqua.timerInSecond22>300  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC2Aqua.timerInSecond22 <= 60 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC2Aqua.timerInSecond22 <= 100 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC2Aqua.timerInSecond22 < 300 && StaticFlag.TotalOx == 5)
			starNo = 1;
