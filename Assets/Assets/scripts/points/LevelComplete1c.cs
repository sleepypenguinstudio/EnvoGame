...
public class LevelComplete1c : MonoBehaviour {
	...
	void Update () {
		if (CountDownC2.timerInSecond2>500  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC2.timerInSecond2 <= 25 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC2.timerInSecond2 <= 30 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC2.timerInSecond2 < 500 && StaticFlag.TotalOx == 5)
			starNo = 1;
