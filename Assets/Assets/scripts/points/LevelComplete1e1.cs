...
public class LevelComplete1e1 : MonoBehaviour {
	...
	void Update () {
		if (CountDownC4Aqua.timerInSecond42>250  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC4Aqua.timerInSecond42 <= 100 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC4Aqua.timerInSecond42 <= 160 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC4Aqua.timerInSecond42 < 250 && StaticFlag.TotalOx == 5)
			starNo = 1;
