...
public class LevelComplete1d : MonoBehaviour {
	...
	void Update () {
		if (CountDownC3.timerInSecond3>500  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC3.timerInSecond3 <= 25 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC3.timerInSecond3 <= 30 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC3.timerInSecond3 < 500 && StaticFlag.TotalOx == 5)
			starNo = 1;
