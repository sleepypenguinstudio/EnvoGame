...
public class LevelComplete1f : MonoBehaviour {
	...
	void Update () {
		if (CountDownC5.timerInSecond5>500  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC5.timerInSecond5 <= 25 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC5.timerInSecond5 <= 30 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC5.timerInSecond5 < 500 && StaticFlag.TotalOx == 5)
			starNo = 1;
