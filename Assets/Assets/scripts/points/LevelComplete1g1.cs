...
public class LevelComplete1g1 : MonoBehaviour {
	...
	void Update () {
		if (CountDownC6Aqua.timerInSecond62>1000  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC6Aqua.timerInSecond62 <= 500 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC6Aqua.timerInSecond62 <= 750 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC6Aqua.timerInSecond62 < 1000 && StaticFlag.TotalOx == 5)
			starNo = 1;
