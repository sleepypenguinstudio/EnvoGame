...
public class LevelComplete1b : MonoBehaviour {
	...
	void Update () {
		if (CountDownC1.timerInSecond1>500  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC1.timerInSecond1 <= 25 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC1.timerInSecond1 <= 30 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC1.timerInSecond1 < 500 && StaticFlag.TotalOx == 5)
			starNo = 1;
