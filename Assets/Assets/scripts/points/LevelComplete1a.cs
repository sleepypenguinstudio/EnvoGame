...
public class LevelComplete1a : MonoBehaviour {
	...
	void Update () {
		if (CountDownC.timerInSecond>500  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC.timerInSecond <= 25 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC.timerInSecond <= 30 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC.timerInSecond < 500 && StaticFlag.TotalOx == 5)
			starNo = 1;
