...
public class LevelComplete1a1 : MonoBehaviour {
	...
	void Update () {
		if (CountDownCAqua.timerInSecond02>250  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownCAqua.timerInSecond02 <= 120 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownCAqua.timerInSecond02 <= 160 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownCAqua.timerInSecond02 < 250 && StaticFlag.TotalOx == 5)
			starNo = 1;
