...
public class LevelComplete1g : MonoBehaviour {
	...
	void Update () {
		if (CountDownC6.timerInSecond6>500  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC6.timerInSecond6 <= 25 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC6.timerInSecond6 <= 30 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC6.timerInSecond6 < 500 && StaticFlag.TotalOx == 5)
			starNo = 1;
