...
public class LevelComplete1f1 : MonoBehaviour {
	...
	void Update () {
		if (CountDownC5Aqua.timerInSecond52>800  && StaticFlag.TotalOx == 5) {
			starNo = 0;
		}
		else if (CountDownC5Aqua.timerInSecond52 <= 300 && StaticFlag.TotalOx == 5) {
			starNo = 3;
		}
		else if (CountDownC5Aqua.timerInSecond52 <= 500 && StaticFlag.TotalOx == 5) {
			starNo = 2;
		}
		else if (CountDownC5Aqua.timerInSecond52 < 800 && StaticFlag.TotalOx == 5)
			starNo = 1;
